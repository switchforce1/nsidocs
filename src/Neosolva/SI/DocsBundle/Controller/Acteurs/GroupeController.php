...
use Neosolva\SI\DocsBundle\Entity\Acteurs\Groupe;
...
class GroupeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $groupes = $em->getRepository('NSIDocsBundle:Acteurs\Groupe')->findAll();

        return $this->render('acteurs/groupe/index.html.twig', array(
            'groupes' => $groupes,
        ));
    }
    ...
    {
        $groupe = new Groupe();
        $form = $this->createForm('Neosolva\SI\DocsBundle\Form\Acteurs\GroupeType', $groupe);
        ...
        return $this->render('acteurs/groupe/new.html.twig', array(
            'groupe' => $groupe,
    ...
    public function showAction(Groupe $groupe)
    {
        ...
        return $this->render('acteurs/groupe/show.html.twig', array(
            'groupe' => $groupe,
    ...
    {
        $deleteForm = $this->createDeleteForm($groupe);
        $editForm = $this->createForm('Neosolva\SI\DocsBundle\Form\Acteurs\GroupeType', $groupe);
        ...
        return $this->render('acteurs/groupe/edit.html.twig', array(
            'groupe' => $groupe,
