...
use Neosolva\SI\DocsBundle\Entity\Acteurs\Acces;
...
class AccesController extends Controller
{
    ...
    {
        $acce = new Acces();
        $form = $this->createForm('Neosolva\SI\DocsBundle\Form\Acteurs\AccesType', $acce);
    ...
    {
        $deleteForm = $this->createDeleteForm($acce);
        $editForm = $this->createForm('Neosolva\SI\DocsBundle\Form\Acteurs\AccesType', $acce);
