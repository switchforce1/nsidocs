...
use Neosolva\SI\DocsBundle\Entity\Acteurs\Personne;
...
class PersonneController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Neosolva\SI\DocsBundle\Form\Acteurs\PersonneType', $personne);
    ...
    {
        $deleteForm = $this->createDeleteForm($personne);
        $editForm = $this->createForm('Neosolva\SI\DocsBundle\Form\Acteurs\PersonneType', $personne);
