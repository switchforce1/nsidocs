...
use Neosolva\SI\DocsBundle\Entity\Document\Section;
...
class SectionController extends Controller
{
    ...
    {
        $section = new Section();
        $form = $this->createForm('Neosolva\SI\DocsBundle\Form\Document\SectionType', $section);
    ...
    {
        $deleteForm = $this->createDeleteForm($section);
        $editForm = $this->createForm('Neosolva\SI\DocsBundle\Form\Document\SectionType', $section);
