...
use Neosolva\SI\DocsBundle\Entity\Document\Fichier;
...
class FichierController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $fichiers = $em->getRepository('NSIDocsBundle:Document\Fichier')->findAll();

        return $this->render('document/fichier/index.html.twig', array(
            'fichiers' => $fichiers,
        ));
    }
    ...
    {
        $fichier = new Fichier();
        $form = $this->createForm('Neosolva\SI\DocsBundle\Form\Document\FichierType', $fichier);
        ...
        return $this->render('document/fichier/new.html.twig', array(
            'fichier' => $fichier,
    ...
    public function showAction(Fichier $fichier)
    {
        ...
        return $this->render('document/fichier/show.html.twig', array(
            'fichier' => $fichier,
    ...
    {
        $deleteForm = $this->createDeleteForm($fichier);
        $editForm = $this->createForm('Neosolva\SI\DocsBundle\Form\Document\FichierType', $fichier);
        ...
        return $this->render('document/fichier/edit.html.twig', array(
            'fichier' => $fichier,
