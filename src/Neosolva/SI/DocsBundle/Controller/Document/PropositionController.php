...
use Neosolva\SI\DocsBundle\Entity\Document\Proposition;
...
class PropositionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $propositions = $em->getRepository('NSIDocsBundle:Document\Proposition')->findAll();

        return $this->render('document/proposition/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Neosolva\SI\DocsBundle\Form\Document\PropositionType', $proposition);
        ...
        return $this->render('document/proposition/new.html.twig', array(
    ...
    public function showAction(Proposition $proposition)
    {
        ...
        return $this->render('document/proposition/show.html.twig', array(
            'proposition' => $proposition,
    ...
    {
        $deleteForm = $this->createDeleteForm($proposition);
        $editForm = $this->createForm('Neosolva\SI\DocsBundle\Form\Document\PropositionType', $proposition);
        ...
        return $this->render('document/proposition/edit.html.twig', array(
            'proposition' => $proposition,
