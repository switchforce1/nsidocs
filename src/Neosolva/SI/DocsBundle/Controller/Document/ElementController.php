...
use Neosolva\SI\DocsBundle\Entity\Document\Element;
...
class ElementController extends Controller
{
    ...
    {
        $element = new Element();
        $form = $this->createForm('Neosolva\SI\DocsBundle\Form\Document\ElementType', $element);
    ...
    {
        $deleteForm = $this->createDeleteForm($element);
        $editForm = $this->createForm('Neosolva\SI\DocsBundle\Form\Document\ElementType', $element);
