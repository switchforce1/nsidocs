...
use Neosolva\SI\DocsBundle\Entity\Organisation\Departement;
...
class DepartementController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Neosolva\SI\DocsBundle\Form\Organisation\DepartementType', $departement);
    ...
    {
        $deleteForm = $this->createDeleteForm($departement);
        $editForm = $this->createForm('Neosolva\SI\DocsBundle\Form\Organisation\DepartementType', $departement);
