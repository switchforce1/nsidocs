...
use Newer\SI\DocsBundle\Entity\Organisation\Employe;
...
class EmployeController extends Controller
{
    ...
    {
        $employe = new Employe();
        $form = $this->createForm('Newer\SI\DocsBundle\Form\Organisation\EmployeType', $employe);
    ...
    {
        $deleteForm = $this->createDeleteForm($employe);
        $editForm = $this->createForm('Newer\SI\DocsBundle\Form\Organisation\EmployeType', $employe);
