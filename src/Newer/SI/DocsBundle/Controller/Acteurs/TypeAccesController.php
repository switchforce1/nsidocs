...
use Newer\SI\DocsBundle\Entity\Acteurs\TypeAcces;
...
class TypeAccesController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Newer\SI\DocsBundle\Form\Acteurs\TypeAccesType', $typeAcce);
    ...
    {
        $deleteForm = $this->createDeleteForm($typeAcce);
        $editForm = $this->createForm('Newer\SI\DocsBundle\Form\Acteurs\TypeAccesType', $typeAcce);
