...
use Newer\SI\DocsBundle\Entity\Acteurs\Attribution;
...
class AttributionController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Newer\SI\DocsBundle\Form\Acteurs\AttributionType', $attribution);
    ...
    {
        $deleteForm = $this->createDeleteForm($attribution);
        $editForm = $this->createForm('Newer\SI\DocsBundle\Form\Acteurs\AttributionType', $attribution);
