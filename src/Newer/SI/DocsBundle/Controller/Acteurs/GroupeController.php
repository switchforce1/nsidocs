...
use Newer\SI\DocsBundle\Entity\Acteurs\Groupe;
...
class GroupeController extends Controller
{
    ...
    {
        $groupe = new Groupe();
        $form = $this->createForm('Newer\SI\DocsBundle\Form\Acteurs\GroupeType', $groupe);
    ...
    {
        $deleteForm = $this->createDeleteForm($groupe);
        $editForm = $this->createForm('Newer\SI\DocsBundle\Form\Acteurs\GroupeType', $groupe);
