...
use Newer\SI\DocsBundle\Entity\Document\Image;
...
class ImageController extends Controller
{
    ...
    {
        $image = new Image();
        $form = $this->createForm('Newer\SI\DocsBundle\Form\Document\ImageType', $image);
    ...
    {
        $deleteForm = $this->createDeleteForm($image);
        $editForm = $this->createForm('Newer\SI\DocsBundle\Form\Document\ImageType', $image);
