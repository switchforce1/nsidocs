...
use Newer\SI\DocsBundle\Entity\Document\Fichier;
...
class FichierController extends Controller
{
    ...
    {
        $fichier = new Fichier();
        $form = $this->createForm('Newer\SI\DocsBundle\Form\Document\FichierType', $fichier);
    ...
    {
        $deleteForm = $this->createDeleteForm($fichier);
        $editForm = $this->createForm('Newer\SI\DocsBundle\Form\Document\FichierType', $fichier);
