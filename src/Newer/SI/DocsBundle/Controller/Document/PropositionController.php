...
use Newer\SI\DocsBundle\Entity\Document\Proposition;
...
class PropositionController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Newer\SI\DocsBundle\Form\Document\PropositionType', $proposition);
    ...
    {
        $deleteForm = $this->createDeleteForm($proposition);
        $editForm = $this->createForm('Newer\SI\DocsBundle\Form\Document\PropositionType', $proposition);
