...
use Newer\SI\DocsBundle\Entity\Document\Creation;
...
class CreationController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Newer\SI\DocsBundle\Form\Document\CreationType', $creation);
    ...
    {
        $deleteForm = $this->createDeleteForm($creation);
        $editForm = $this->createForm('Newer\SI\DocsBundle\Form\Document\CreationType', $creation);
