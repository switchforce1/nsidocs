...
use Newer\SI\DocsBundle\Entity\Document\Paragraphe;
...
class ParagrapheController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Newer\SI\DocsBundle\Form\Document\ParagrapheType', $paragraphe);
    ...
    {
        $deleteForm = $this->createDeleteForm($paragraphe);
        $editForm = $this->createForm('Newer\SI\DocsBundle\Form\Document\ParagrapheType', $paragraphe);
