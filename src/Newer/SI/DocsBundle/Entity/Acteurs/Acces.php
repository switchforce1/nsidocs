 ...
 * @ORM\Entity(repositoryClass="Newer\SI\DocsBundle\Repository\Acteurs\AccesRepository")
 */
class Acces
{
    /**
	...
	/**
     * Many Utilisateur have One TypeUtilisateur.
     * @ORM\ManyToOne(targetEntity="Newer\SI\DocsBundle\Entity\Document\Document",
	 *					 inversedBy="acess")
