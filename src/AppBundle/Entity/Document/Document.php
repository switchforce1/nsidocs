 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Document\DocumentRepository")
 */
class Document
{
    /**
     ...
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Acteurs\Acces", mappedBy="document")
     */
	protected $access;
