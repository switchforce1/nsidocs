...
use AppBundle\Entity\Document\Element;
...
class ElementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $elements = $em->getRepository('AppBundle:Document\Element')->findAll();

        return $this->render('AppBundle:Document:Element/index.html.twig', array(
            'elements' => $elements,
        ));
    }
    ...
    {
        $element = new Element();
        $form = $this->createForm('AppBundle\Form\Document\ElementType', $element);
        ...
        return $this->render('AppBundle:Document:Element/new.html.twig', array(
            'element' => $element,
    ...
    public function showAction(Element $element)
    {
        ...
        return $this->render('AppBundle:Document:Element/show.html.twig', array(
            'element' => $element,
    ...
    {
        $deleteForm = $this->createDeleteForm($element);
        $editForm = $this->createForm('AppBundle\Form\Document\ElementType', $element);
        ...
        return $this->render('AppBundle:Document:Element/edit.html.twig', array(
            'element' => $element,
