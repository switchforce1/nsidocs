...
use AppBundle\Entity\Document\Image;
...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $images = $em->getRepository('AppBundle:Document\Image')->findAll();

        return $this->render('AppBundle:Document:Image/index.html.twig', array(
            'images' => $images,
        ));
    }
    ...
    {
        $image = new Image();
        $form = $this->createForm('AppBundle\Form\Document\ImageType', $image);
        ...
        return $this->render('AppBundle:Document:Image/new.html.twig', array(
            'image' => $image,
    ...
    public function showAction(Image $image)
    {
        ...
        return $this->render('AppBundle:Document:Image/show.html.twig', array(
            'image' => $image,
    ...
    {
        $deleteForm = $this->createDeleteForm($image);
        $editForm = $this->createForm('AppBundle\Form\Document\ImageType', $image);
        ...
        return $this->render('AppBundle:Document:Image/edit.html.twig', array(
            'image' => $image,
