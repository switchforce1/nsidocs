...
use AppBundle\Entity\Organisation\Departement;
...
class DepartementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $departements = $em->getRepository('AppBundle:Organisation\Departement')->findAll();

        return $this->render('AppBundle:Organisation:Departement/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\Organisation\DepartementType', $departement);
        ...
        return $this->render('AppBundle:Organisation:Departement/new.html.twig', array(
    ...
    public function showAction(Departement $departement)
    {
        ...
        return $this->render('AppBundle:Organisation:Departement/show.html.twig', array(
            'departement' => $departement,
    ...
    {
        $deleteForm = $this->createDeleteForm($departement);
        $editForm = $this->createForm('AppBundle\Form\Organisation\DepartementType', $departement);
        ...
        return $this->render('AppBundle:Organisation:Departement/edit.html.twig', array(
            'departement' => $departement,
