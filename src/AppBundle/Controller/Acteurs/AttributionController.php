...
use AppBundle\Entity\Acteurs\Attribution;
...
class AttributionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $attributions = $em->getRepository('AppBundle:Acteurs\Attribution')->findAll();

        return $this->render('AppBundle:Acteurs:Attribution/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\Acteurs\AttributionType', $attribution);
        ...
        return $this->render('AppBundle:Acteurs:Attribution/new.html.twig', array(
    ...
    public function showAction(Attribution $attribution)
    {
        ...
        return $this->render('AppBundle:Acteurs:Attribution/show.html.twig', array(
            'attribution' => $attribution,
    ...
    {
        $deleteForm = $this->createDeleteForm($attribution);
        $editForm = $this->createForm('AppBundle\Form\Acteurs\AttributionType', $attribution);
        ...
        return $this->render('AppBundle:Acteurs:Attribution/edit.html.twig', array(
            'attribution' => $attribution,
