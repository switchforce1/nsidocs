...
class TypeUtilisateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $typeUtilisateurs = $em->getRepository('AppBundle:Acteurs\TypeUtilisateur')->findAll();

        return $this->render('AppBundle:Acteurs:TypeUtilisateur/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\Acteurs\TypeUtilisateurType', $typeUtilisateur);
        ...
        return $this->render('AppBundle:Acteurs:TypeUtilisateur/new.html.twig', array(
    ...
    public function showAction(TypeUtilisateur $typeUtilisateur)
    {
        ...
        return $this->render('AppBundle:Acteurs:TypeUtilisateur/show.html.twig', array(
            'typeUtilisateur' => $typeUtilisateur,
    ...
    {
        $deleteForm = $this->createDeleteForm($typeUtilisateur);
        $editForm = $this->createForm('AppBundle\Form\Acteurs\TypeUtilisateurType', $typeUtilisateur);
        ...
        return $this->render('AppBundle:Acteurs:TypeUtilisateur/edit.html.twig', array(
            'typeUtilisateur' => $typeUtilisateur,
