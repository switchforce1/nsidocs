...
use AppBundle\Entity\Acteurs\Personne;
...
class PersonneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $personnes = $em->getRepository('AppBundle:Acteurs\Personne')->findAll();

        return $this->render('AppBundle:Acteurs:Personne/index.html.twig', array(
            'personnes' => $personnes,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\Acteurs\PersonneType', $personne);
        ...
        return $this->render('AppBundle:Acteurs:Personne/new.html.twig', array(
            'personne' => $personne,
    ...
    public function showAction(Personne $personne)
    {
        ...
        return $this->render('AppBundle:Acteurs:Personne/show.html.twig', array(
            'personne' => $personne,
    ...
    {
        $deleteForm = $this->createDeleteForm($personne);
        $editForm = $this->createForm('AppBundle\Form\Acteurs\PersonneType', $personne);
        ...
        return $this->render('AppBundle:Acteurs:Personne/edit.html.twig', array(
            'personne' => $personne,
